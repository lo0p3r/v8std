...
Функция ДанныеРесурса(АдресРесурса, Таймаут = 10, Повторно = Ложь)
	...
	ПараметрыЗапроса.Заголовки.Вставить("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/139.0.0.0 Safari/537.36");
	ПараметрыЗапроса.Заголовки.Вставить("Content-Type", "text/html;charset=windows-1251");
